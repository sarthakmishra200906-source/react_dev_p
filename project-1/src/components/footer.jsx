...
const ComponentName = () => {        
    return (
        <section className="py-10 bg-white border-top border-gray-200 sm:pt-16 lg:pt-24 w-full mt-auto">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <img className="w-auto h-9" src="https://cdn.rareblocks.xyz/collection/celebration/images/logo.svg" alt="Logo" />

                        <p className="text-base leading-relaxed text-gray-600 mt-7">
                            AI-Powered Task & Multi-Modal Document Intelligence with Local RAG pipeline.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            ...
                            <li><a href="#" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Features </a></li>
                            <li><a href="#" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Works </a></li>
                            <li><a href="#" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Career </a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            ...
                            <li><a href="#" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Delivery Details </a></li>
                ...
                <p className="text-sm text-center text-gray-600">© Copyright 2026, All Rights Reserved</p>
            </div>
        </section>
    );
};
